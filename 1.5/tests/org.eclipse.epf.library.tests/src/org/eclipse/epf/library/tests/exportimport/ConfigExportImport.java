 ...
 * 
 */
public class ConfigExportImport extends ExportImportTestImpl {

	public ConfigExportImport(String name) {
		super(name);
	}	
	...
	public void test0001_1() {
		...
		new ConfigExportImportTest0001(this).execute("test0001_1");
